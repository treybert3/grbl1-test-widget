    ...
    return {
                    ...
                    case 'status':
                        ...
                        if (status.exec(fields[0])) {
                            if (fields[0].indexOf('Hold:') >= 0 || fields[0].indexOf('Door:') >= 0) {
                                ...
                                // adding correct button status
                                $('#com-chilipeppr-widget-grbl .grbl-feedhold').html("!");
                                $('#com-chilipeppr-widget-grbl .grbl-cyclestart').html('Resume').addClass("btn-success");
                            }
                            else {
        ...
        wsSendCode: function(sendline){
            ...
            if (this.singleSelectPort.Name !== undefined && sendline != ''){
                ...
                if(this.widgetDebug) console.log("GRBL WIDGET: wsSendCode try sending outside the buffer.", send);    
            }
            else{
                // chilipeppr.publish("/com-chilipeppr-widget-serialport/requestSingleSelectPort", "");
