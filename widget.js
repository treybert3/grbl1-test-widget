            ...
            if (msg.indexOf("ok") >= 0 || msg.indexOf("error") >= 0) { //expected response
                ...
                if (msg.indexOf("PRB:") >= 0) {
                    ...
                    if (WPos_flag === true) {
                        ...
                        if (this.work_mode === this.report_mode)
                            this.publishAxisStatus({
                                "posx": parseFloat(this.last_work.x),
                                "posy": parseFloat(this.last_work.y),
                                "posz": parseFloat(this.last_work.z)
                            });
                        else if (this.work_mode === 1 && this.report_mode === 0) //work is inch, reporting in mm
                            this.publishAxisStatus({
                            "posx": this.toInch(parseFloat(this.last_work.x)),
                            ...
                            this.publishAxisStatus({
                            "posx": this.toMM(parseFloat(this.last_work.x)),
                        ...
                        if (this.work_mode === this.report_mode)
                            this.publishAxisStatus({
                                "posx": parseFloat(this.last_machine.x),
                                "posy": parseFloat(this.last_machine.y),
                                "posz": parseFloat(this.last_machine.z)
                            });
                        else if (this.work_mode === 1 && this.report_mode === 0) //work is inch, reporting in mm
                            this.publishAxisStatus({
                            "posx": this.toInch(parseFloat(this.last_machine.x)),
                            "posy": this.toInch(parseFloat(this.last_machine.y)),
                            "posz": this.toInch(parseFloat(this.last_machine.z))
                        });
                        else if (this.work_mode === 0 && this.report_mode === 1) //work is mm, reporting in inch
                            this.publishAxisStatus({
                            "posx": this.toMM(parseFloat(this.last_machine.x)),
                            "posy": this.toMM(parseFloat(this.last_machine.y)),
                            "posz": this.toMM(parseFloat(this.last_machine.z))
                        });
                    }
                    else {
