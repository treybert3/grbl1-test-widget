                        ...
                        for (i = 1; i < fields.length; i++) {
                            ...
                            switch (bit[0].toLowerCase()) {
                                ...
                                case "fs":
									...
									var bits = result[1].split(',');
									var feedRate = 	that.controller_units === "inch"?
													that.toMM(parseFloat(bits[0])) :
													parseFloat(bits[0]);
									$('.stat-feedrate').html(feedRate.toFixed(2));
									var spindleSpeed = parseInt(bits[1],10);
                                ...
                                case "ov":
									...
									var bits = result[1].split(',');
									that.overrides={
										feedRate: parseInt(bits[0], 10),
										rapids:	parseInt(bits[1], 10),
										spindleSpeed: parseInt(bits[2],10)
									};
