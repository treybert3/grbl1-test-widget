    ...
    return {
        ...
        showConfigModal: function() {
            ...
            var interval = setInterval(function(context) {
                ...
                var switchNode = $("<div class='configItemHolder boolean input-group input-group-sm'><input type='checkbox' /><label class='input-group input-group-sm'></label></div>");
